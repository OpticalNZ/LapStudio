...
anything is corrected. It is a tick beside Invert and Smooth in the channel
mapping, one per G axis, greyed out for an axis that is already level or has not
been measured - so the state of the tick is the report. `gsensor.py`.
